...
public class SimpleItemBasedRecommender {

  private final Recommender recommender;

  public SimpleItemBasedRecommender(DataModel dataModel) throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    ...
    List<SimpleOrder> simpleOrders = client.getAllSimpleOrders(1, 20);
    ...
    SimpleItemBasedRecommender osDataRecommender = new SimpleItemBasedRecommender(osDataModel);
    ...
    SimpleItemBasedRecommender fileBasedRecommender = new SimpleItemBasedRecommender(fileDataModel);
